...
<h2 id="dashboard-title">Chapitres publiés et brouillons</h2>

<div class="col s12 m12 l12">
    <a class="btn waves-effect waves-light right" href="index.php?url=allpublishedposts">Masquer les brouillons</a>
</div>
            ...
            <div class="row">
                <div class="col s12 m12 l8">
                    ...
                    if ($post->posted == "0") {
                        ...
                        echo  '<a class="btn waves-effect waves-light right red" href="index.php?url=deletepost&id=' . $post->id . '">Supprimer</a>';
                    } else {
                        echo  '';
                    }
